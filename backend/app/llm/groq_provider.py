...
class GroqProvider(BaseLLMProvider):
    def _client(self):
        # Groq exposes an OpenAI-compatible API; LangChain's ChatOpenAI can be pointed via base_url.
        return ChatOpenAI(api_key=self.api_key, model=self.model, temperature=0, base_url="https://api.groq.com/openai/v1")
